...
function AnimatedNavLink({ href, children }: AnimatedNavLinkProps) {
  return (
    <a
      href={href}
      className="group relative inline-flex h-5 items-center overflow-hidden text-xs font-medium uppercase tracking-[0.18em] text-white/72 sm:text-sm"
    >
    ...
    >
      <div className="flex items-center justify-between gap-x-6">
        ...
        <div className="hidden items-center gap-2 sm:flex">
          <a
            href="#philosophy"
            className="rounded-full border border-white/10 bg-white/6 px-4 py-2 text-xs font-medium uppercase tracking-[0.14em] text-white/80 transition hover:bg-white/10 hover:text-white"
          >
            Обзор
          </a>
          <a
            href="#growth-cycle"
            className="rounded-full bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.14em] text-black transition hover:bg-white/92"
          >
            Смотреть цикл
          </a>
        </div>
      ...
      >
        <nav className="flex flex-col items-center gap-4 border-t border-white/8 pt-4">
          ...
          <div className="mt-2 flex w-full flex-col gap-3">
            <a
              href="#philosophy"
              className="rounded-full border border-white/10 bg-white/6 px-4 py-3 text-center text-xs font-medium uppercase tracking-[0.14em] text-white/80 transition hover:bg-white/10 hover:text-white"
              onClick={() => setIsOpen(false)}
            >
              Обзор
            </a>
            <a
              href="#growth-cycle"
              className="rounded-full bg-white px-4 py-3 text-center text-xs font-semibold uppercase tracking-[0.14em] text-black transition hover:bg-white/92"
              onClick={() => setIsOpen(false)}
            >
              Смотреть цикл
            </a>
